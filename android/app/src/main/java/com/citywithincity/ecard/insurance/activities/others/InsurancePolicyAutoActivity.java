...
@Observer
@EventHandler
public class InsurancePolicyAutoActivity extends BaseActivity implements IOnTextClickListener {

	private InsurancePolicyVo data;
	
	@Override
	protected void onSetContent(Bundle savedInstanceState) {
		setContentView(R.layout.activity_insurance_policy_auto);
		setTitle("保单详情");
	...
	private void initView() {
		...
		if (data.applicants != null) {
			...
			ViewUtil.setTextFieldValue(this, R.id.car_no, data.applicants.CAR_NO);
			ViewUtil.setTextFieldValue(this, R.id.car_frame, data.applicants.VIN);
		}
