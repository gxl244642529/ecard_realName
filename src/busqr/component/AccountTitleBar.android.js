    ...
    return (
      <View style={styles.headerTitle}>
          ...
          <View style={{position:'absolute',
            ...
            <Text style={{backgroundColor:'transparent',color:'#fff',justifyContent:'center',alignItems:'center',marginTop:10,marginLeft:20}}>余额管理</Text>
            <TouchableAll onPress={this._gotoQrtrans} style={{width:80,height:40, justifyContent:'center',alignItems:'center',}}>
