...
class FlowGrid extends Component{
  ...
  constructor(props){
    ...
    for(var i=0; i < c ; ++i){
      arr.push([props.children[i],props.children[i+1]]);
    }
          ...
          <View style={styles.main}>
            <ScrollView
              ...
              <View style={styles.imageGroup}>
                ...
                <MainButton requireLogin={true} url="myecard" source={main3} />
              ...
              <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={styles.centerGroup}>
                <SubButton title="惠民理财" url="licai" source={require('./images/sub1.png')} />
                <SubButton title="公交" url="bus" source={require('./images/sub2.png')} />
                <SubButton title="保险" url="safe" source={require('./images/sub3.png')} />
                <SubButton title="平安之家" requireLogin={true} url="/pingan" source={require('./images/sub4.png')} />
                ...
                <SubButton title="常见问题" url="question" source={require('./images/sub7.png')} />
