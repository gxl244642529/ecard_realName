...
public class StateHandler implements IDestroyable, OnClickListener {
	...
	public StateHandler(Context context,ViewGroup parent) {
	...
	private void createLoading(){
		if(loading>0 && progress==null){
			...
			parent.addView(progress,new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		}
	...
	private void createError(){
		if(error>0 && errorView==null){
			...
			parent.addView(errorView, new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
	...
	private void createNoResult(){
		if(no_result>0 && noResult==null){
			...
			parent.addView(noResult, new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
