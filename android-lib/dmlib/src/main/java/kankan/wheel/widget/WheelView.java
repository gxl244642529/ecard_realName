...
public class WheelView extends View {
	 ...
	 */
	protected void notifyChangingListeners(int oldValue, int newValue,int mode) {
		for (OnWheelChangedListener listener : changingListeners) {
			listener.onChanged(this, oldValue, newValue,mode);
		}
	}
	...
	public static final int ScrollMode = 1;
	 ...
	 */
	public void setCurrentItem(int index, boolean animated,int mode) {
		...
		if (index != currentItem) {
			if (animated) {
				...
				notifyChangingListeners(old, currentItem,mode);
	 ...
	 * @param index the item index
	 */
	public void setCurrentItem(int index,int mode) {
		setCurrentItem(index, false,mode);
	}
	...
	private void doScroll(int delta) {
		...
		if (pos != currentItem) {
			setCurrentItem(pos, false,ScrollMode);
		} else {
			invalidate();
		}
