...
export default class Swiper extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    const sizeChanged = (nextProps.width || width) !== this.state.width || (nextProps.height || height) !== this.state.height
    if (!nextProps.autoplay ) {
      ...
      if(!this.autoplayTimer ){
        this.autoplayTimer = setInterval(this.doAutoPay,this.props.autoplayTimeout * 1000)
      }
